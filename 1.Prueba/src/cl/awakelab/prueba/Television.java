...
public class Television extends Electrodomestico {
	...
	/**
	 * Constructor vacio que genera un objeto Electrodomestico de tipo Television,
	 * que hereda sus atributos por defecto de la clase padre. Asigna el valor por
	 * defecto a resolucion y tdt.
	 */
	public Television() {
		super();
	 ...
	 * genera un objeto Electrodomestico de tipo television, con sus demas valores
	 * dados por defecto.
	 * 
	 ...
	 * energetico,resolucion y tdt por parte del usuario y genera un objeto de tipo
	 * Electrodomestico
	 * 
	 * @param precioBase        Precio del electrodomestico
	 * @param peso              Peso del electrodomestico
	 ...
	 */
	public Television(int precioBase, int peso, String color, char consumoEnergetico, int resolucion, boolean tdt) {
	...
	public String toString() {
		return "Television [Precio Base: $" + precioBase + "]" + "[" + "Color: " + color + "]" + "["
				+ "Consumo Energetico: " + consumoEnergetico + "]" + "[" + "Peso: " + peso + "]" + "[" + "Pulgadas: "
				+ resolucion + "]" + "[" + "TDT: " + tdt + "]" + "[" + "Precio Final: $" + precioFinal() + "]";
	}
}
