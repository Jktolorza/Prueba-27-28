...
public class Lavadora extends Electrodomestico {
	...
	/**
	 * Constructor vacio que genera un objeto Electrodomestico de tipo lavadora, que hereda
	 * sus atributos por defecto de la clase padre.
	 * Asigna el valor por defecto a carga.
	 */
	public Lavadora() {
		super();
	 ...
	 * y genera un objeto Electrodomestico de tipo lavadora, con sus demas valores dados por
	 * defecto.
	...
	/**
	 * Constructor que recive los valores de precio, peso, color y consumo y genera un objeto 
	 * Electrodomestico de tipo lavadora.
	 * @param precioBase Precio del electrodomestico
	 * @param peso   Peso del electrodomestico
